package gov.srs.spring.services.NCHANDIWebsite_Service.advice;
...
import gov.srs.spring.services.NCHANDIWebsite_Service.exceptions.MissingRolesException;
...
public class SecurityAdvice {
	...
	@Before("within(gov.srs.spring.services.trend.controllers.*)")
