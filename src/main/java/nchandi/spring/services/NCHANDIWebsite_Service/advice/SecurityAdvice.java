		...
		if (aspectenabled.equals("true")) {
			...
			if (userroles != null) {
				...
				if (allowedroles != null) {
					...
					throw new MissingRolesException("Could not find roles for this user");
			} else
				throw new MissingRolesException("No security groups could be found for this application.");
		}
	}
