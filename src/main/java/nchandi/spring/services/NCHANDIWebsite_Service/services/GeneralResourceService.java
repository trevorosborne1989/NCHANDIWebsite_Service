...
import nchandi.spring.services.NCHANDIWebsite_Service.domain.GeneralResource;
import nchandi.spring.services.NCHANDIWebsite_Service.repositories.GeneralResourceRepository;
...
public class GeneralResourceService {
	...
	Logger logger = LoggerFactory.getLogger("nchandi.spring.services.NCHANDIWebsite_Service.services.GeneralResourceService");
