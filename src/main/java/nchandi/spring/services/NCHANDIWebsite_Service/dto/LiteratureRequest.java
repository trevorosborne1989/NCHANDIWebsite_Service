...
public class LiteratureRequest {
  ...
  public int getLivingSoberQty() {
    return this.livingSoberQty;
  }

  public void setLivingSoberQty(int livingSoberQty) {
    this.livingSoberQty = livingSoberQty;
  }

  public int getStepsAndTraditions12x12Qty() {
    return this.stepsAndTraditions12x12Qty;
  }

  public void setStepsAndTraditions12x12Qty(int stepsAndTraditions12x12Qty) {
    this.stepsAndTraditions12x12Qty = stepsAndTraditions12x12Qty;
  }

  public int getAaPaperbackQty() {
    return this.aaPaperbackQty;
  }

  public void setAaPaperbackQty(int aaPaperbackQty) {
  ...
  public void setNewcomerPacketsQty(int newcomerPacketsQty) {
